...
//        Log.v(TAG, "ChatManager.getloggedUser");
     ...
     * @param loginActivity
     */
    public static void startAnonymously(final AppCompatActivity loginActivity, final ChatAuthentication.OnChatLoginCallback onChatLoginCallback) {
     ...
     * @param appId
     */
    public static void startAnonymously(final AppCompatActivity loginActivity, final String appId, final ChatAuthentication.OnChatLoginCallback onChatLoginCallback) {
    ...
    public static void startWithEmailAndPassword(
            final AppCompatActivity loginActivity,
            final String appId,
...
//    }
    ...
    public void sendLocation(String recipientId, String recipientFullName, String text, String channelType,
                                 Map metadata, SendMessageListener sendMessageListener) {
        ...
        getConversationMessagesHandler(recipientId, recipientFullName).sendMessage(
                Message.TYPE_LOCATION, text, channelType, metadata, sendMessageListener);
    }
