...
// Prevent form the reflection api.
    ...
    @Deprecated
    public void signInWithUid(final AppCompatActivity loginActivity, final String appId,
...
//                    .setValue(userId);
    ...
    public void signInAnonymously(final AppCompatActivity loginActivity, final OnChatLoginCallback onChatLoginCallback) {
    ...
    public void createUserOnFirebaseAuthentication(final AppCompatActivity activity,
                                                   final String email,
...
//                        Toast.makeText(ChatSignUpActivity.this, "createUserWithEmail:onComplete:" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
    ...
    public void createUserOnContacts(String key, Map<String, Object> user,
                ...
                .setValue(user, new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                        if (databaseError == null) {
                            ...
                            if (authInstance.getFirebaseAuth().getCurrentUser()!=null){
                                authInstance.setFullName(user.get("firstname").toString()+" "+ user.get("lastname").toString());
                                UserProfileChangeRequest profileUpdates = new UserProfileChangeRequest.Builder()

                                        .setDisplayName(authInstance.getFullName()).build();

                                authInstance.getFirebaseAuth().getCurrentUser() .updateProfile(profileUpdates);
                            }
    ...
    public void signInWithEmailAndPassword(final AppCompatActivity loginActivity, final String email, final String password,
    ...
    public void signInWithToken(final AppCompatActivity loginActivity, String token,
                                final OnChatLoginCallback onChatLoginCallback) {
