...
import org.chat21.android.utils.GpsLocationTracker;
...
public class MessageListActivity extends AppCompatActivity
    ...
    final private int REQUEST_CODE_ASK_FILE = 124;
    ...
    private ImageView main_activity_send_location;
...
//        }
    ...
    private void registerViews() {
        ...
        main_activity_send_location = (ImageView) findViewById(R.id.main_activity_send_location);
   ...
   /*     toolbar.setOnClickListener(new View.OnClickListener() {
    ...
    private void initInputPanel() {
        ...
        main_activity_send_location.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
...
//                            Toast.LENGTH_SHORT).show();
                ...
                Log.d(TAG, "sendMessage: "+ FirebaseAuth.getInstance().getCurrentUser().getUid());
                Log.d(TAG, "sendMessage: "+ FirebaseAuth.getInstance().getCurrentUser().getDisplayName());
    ...
    private void checkFilePermession() {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent
        ...
        if (requestCode == _INTENT_ACTION_GET_PICTURE) {
            if (data != null && data.getData() != null && resultCode == RESULT_OK) {
                ...
                File fileToUpload = new File(StorageHandler.getPathFromUri(this, uri));
...
//                })
    ...
    void checkPermession() {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) !=
                ...
                getUserLocation();
               // Toast.makeText(this,"Check Location Permssion!",Toast.LENGTH_SHORT).show();
            }
        }else{
            getUserLocation();
        }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        } else if (requestCode == REQUEST_CODE_ASK_FILE) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
    ...
    private void showConfirmSendingLocationsDialog(final Location mylocation) {

        new AlertDialog.Builder(this)
                .setTitle(R.string.share_location)
                .setMessage(R.string.do_you_want_share_your_location)
                .setPositiveButton(getString(android.R.string.yes), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {

                        ChatManager.getInstance().sendLocation(recipient.getId(),
                                recipient.getFullName(), mylocation.getLatitude()+","+mylocation.getLongitude(), channelType,
                                null, null);
                    }
                })
                .setNegativeButton(getString(android.R.string.no), new DialogInterface.OnClickListener() {
    ...
    public void getUserLocation() {
        ...
        if (mGpsLocationTracker!=null&&mGpsLocationTracker.getLocation()!=null){
            showConfirmSendingLocationsDialog(mGpsLocationTracker.getLocation());
            return;
        }
        mGpsLocationTracker = new GpsLocationTracker(this, new LocationListener() {
            @Override
            public void onLocationChanged(@NonNull Location location) {
                mGpsLocationTracker.stopUsingGps();
                showConfirmSendingLocationsDialog(location);
            }
