...
import org.chat21.android.ui.conversations.listeners.OnLocationMessageClickListener;
...
public class ChatUI implements Serializable {
    ...
    private OnLocationMessageClickListener onLocationMessageClickListener;
...
//    }
    ...
    public OnLocationMessageClickListener getOnLocationMessageClickListener() {
        return onLocationMessageClickListener;
    }
   ...
   public void setOnLocationMessageClickListener(OnLocationMessageClickListener onLocationMessageClickListener) {
        Log.d(TAG, "setOnMessageClickListener");
        this.onLocationMessageClickListener = onLocationMessageClickListener;
    }
