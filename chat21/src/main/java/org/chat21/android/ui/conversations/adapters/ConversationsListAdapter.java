...
public class ConversationsListAdapter extends AbstractRecyclerAdapter<Conversation,
    ...
    private void setTextButton(ViewHolder holder, Conversation conversation) {
        if(conversation.getIs_new()) {
            holder.unread.setText(holder.itemView.getResources().getString(R.string.read));
        } else {
            holder.unread.setText(holder.itemView.getResources().getString(R.string.unread));
        }
    }
